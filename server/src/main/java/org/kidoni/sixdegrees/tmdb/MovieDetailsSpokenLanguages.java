...
public class MovieDetailsSpokenLanguages {
    ...
    /**
     * Return true if this movie_details_200_response_spoken_languages_inner object is equal to o.
     */
    @Override
    ...
    public String toUrlQueryString(String prefix) {
        ...
        if (getEnglishName() != null) {
            joiner.add(String.format("%senglish_name%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getEnglishName()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
        }

        // add `iso_639_1` to the URL query string
        if (getIso6391() != null) {
            joiner.add(String.format("%siso_639_1%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getIso6391()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
        }
